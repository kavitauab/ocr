...
- For Vecticum partner mapping, uncertain is no match: only exact VAT or exact normalized legal-name matches may auto-fill `counterparty`; otherwise leave it blank.
